...
function PriceTrackerMenu:InitAddonMenu()
  ...
  local optionsData = {
    ...
    },
    {
      ...
      text = "The average price of all items, with date taken into account. The latest data gets a weighting of X, where X is the number of days the data covers, thus making the newest data worth more. This statistics takes into account trends in prices."
    },
    {
      type = "header",
